//
//  DiaryTextTestViewController.swift
//  Todoary
//
...
extension DiaryTestViewController: UITableViewDelegate, UITableViewDataSource{
...
extension DiaryTestViewController: UITextViewDelegate {

    func textViewDidBeginEditing(_ textView: UITextView) {
        self.selectedStickerView = nil
        if textView.text == DiaryTestView.textViewPlaceHolder {
            textView.text = nil
    ...
    func textViewDidEndEditing(_ textView: UITextView) {
        if textView.text.trimmingCharacters(in: .whitespacesAndNewlines).isEmpty {
            textView.text = DiaryTestView.textViewPlaceHolder
            textView.setTextWithLineHeight(spaing: 25)
...
extension DiaryTestViewController{
    ...
    func checkTextValidationAndRequestApi(){
        if(mainView.textView.text == DiaryTestView.textViewPlaceHolder || mainView.diaryTitle.text!.isEmpty){
